...
> 
## 선언
> USGFramework.Runtime.Contents.MatchAPI.GetQuickMatchUgc()
## 주의사항
|    **함수 동작 환경**    | **동작 여부** |
|:------------------:|:---------:|
| ```Client Logic``` |  ```O```  |
...
|        **형식**         | **파라미터** |  **설명**   |
|:---------------------:|:--------:|:---------:|
| [UgcBase](UgcBase.md) | ResData  | 해당 UGC 정보 |

## Sample Code
```lua
--Call
function this.CallFunction()
       local ResData = USGFramework.Runtime.Contents.MatchAPI.GetQuickMatchUgc()
