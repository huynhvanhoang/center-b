# GetMatchUgc
## 설명
> 매칭 진행 중인 UGC의 정보를 조회합니다.

## 선언
> USGFramework.Runtime.Contents.MatchAPI.GetMatchUgc()
...
|          **형식**           | **파라미터** |  **설명**   |
|:-------------------------:|:--------:|:---------:|
| [UgcDetail](UgcDetail.md) | ResData  | 해당 UGC 정보 |

## Sample Code
```lua
--Call
function this.CallFunction()
       local ResData = USGFramework.Runtime.Contents.MatchAPI.GetMatchUgc()
