...
## 선언
> USGFramework.Runtime.Contents.DataStoreAPI.IncrementDataStoreEntryGlobal
...
```lua
--Call
function this.Call_IncrementDataStoreEntryGlobal()
        local Key = USGFramework.Runtime.Contents.APIDataStruct.EntryKey.New("Test","TestKey")
        USGFramework.Runtime.Contents.DataStoreAPI.IncrementDataStoreEntryGlobal(this.CallBack_IncrementDataStoreEntryGlobal,Key,10)
end
```

```lua
--CallBack
function this.CallBack_IncrementDataStoreEntryGlobal(result,EntryValue)
